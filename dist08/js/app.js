(() => {
    ...
    const script_text = `Discover Your Life, Travel Where You Want`;
    ...
    function checkHeight() {
        const block = document.querySelector(".travelling");
        if (document.documentElement.scrollHeight < 500) block.classList.add("no-margin"); else block.classList.remove("no-margin");
    }
