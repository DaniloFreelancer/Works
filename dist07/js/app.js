(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".tranding__slider")) new swiper_core_Swiper(".tranding__slider", {
            ...
            navigation: {
                prevEl: ".tranding__arrow--left",
                nextEl: ".tranding__arrow--right"
            },
            breakpoints: {
                319: {
                    slidesPerView: 1
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        const e = document.getElementById("line1"), t = document.getElementById("line2"), s = e.getTotalLength(), i = t.getTotalLength();
        e.style.strokeDasharray = s, e.style.strokeDashoffset = -s, t.style.strokeDasharray = i, 
        t.style.strokeDashoffset = -i, setTimeout((function() {
            e.style.transition = "stroke-dashoffset 2s ease-in-out", e.style.strokeDashoffset = 0, 
            e.addEventListener("transitionend", (function() {
                t.style.transition = "stroke-dashoffset 2s ease-in-out", t.style.strokeDashoffset = 0;
            }));
        }), 500);
    }));
    window["FLS"] = true;
