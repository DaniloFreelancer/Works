 ...
 /*! smooth-scroll v16.1.3 | (c) 2020 Chris Ferdinandi | MIT License | http://github.com/cferdinandi/smooth-scroll */            window.Element && !Element.prototype.closest && (Element.prototype.closest = function(e) {
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".character__slider")) new swiper_core_Swiper(".character__slider", {
        ...
        da.init();
        const track = document.querySelector(".sponsors__items");
        const bodyTrack = document.querySelector(".sponsors__body");
        const duplicateContent = track.innerHTML;
        track.innerHTML += duplicateContent;
        let position = 0;
        let speed = 1.5;
        const resetPoint = track.scrollWidth / 2 + 10;
        bodyTrack.addEventListener("mouseover", (function() {
            speed = 0;
        }));
        bodyTrack.addEventListener("mouseout", (function() {
            speed = 1.5;
        }));
        function animate() {
            position -= speed;
